...
// Point hreflang at the French home; canonical stays "/" (this is the English
// landing). Other metadata (title, openGraph, the file-based card) is inherited
