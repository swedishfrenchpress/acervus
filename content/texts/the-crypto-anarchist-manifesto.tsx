...
// Written mid-1988; read at the September 1992 cypherpunks founding meeting and
// posted to the list on 22 November 1992. Reproduced verbatim from
// activism.net/cypherpunk/crypto-anarchy.html, including May's 1992 cover note.

export default function TheCryptoAnarchistManifesto() {
  return (
    <>
      <blockquote>
        <p>Cypherpunks of the World,</p>
        <p>
          Several of you at the &ldquo;physical Cypherpunks&rdquo; gathering
          yesterday in Silicon Valley requested that more of the material passed
          out in meetings be available electronically to the entire readership of
          the Cypherpunks list, spooks, eavesdroppers, and all. &lt;Gulp&gt;
        </p>
        <p>
          Here&rsquo;s the &ldquo;Crypto Anarchist Manifesto&rdquo; I read at the
          September 1992 founding meeting. It dates back to mid-1988 and was
          distributed to some like-minded techno-anarchists at the &ldquo;Crypto
          &rsquo;88&rdquo; conference and then again at the &ldquo;Hackers
          Conference&rdquo; that year. I later gave talks at Hackers on this in
          1989 and 1990.
        </p>
        <p>
          There are a few things I&rsquo;d change, but for historical reasons
          I&rsquo;ll just leave it as is. Some of the terms may be unfamiliar to
          you&hellip;I hope the Crypto Glossary I just distributed will help.
        </p>
        <p>(This should explain all those cryptic terms in my .signature!)</p>
        <p>&mdash;Tim May</p>
      </blockquote>
      ...
      <p>
        The technology for this revolution&mdash;and it surely will be both a
        social and economic revolution&mdash;has existed in theory for the past
        decade. The methods are based upon public-key encryption, zero-knowledge
        ...
        monitored closely by the National Security Agency. But only recently have
        computer networks and personal computers attained sufficient speed to
        make the ideas practically realizable. And the next ten years will bring
        enough additional speed to make the ideas economically feasible and
        essentially unstoppable. High-speed networks, ISDN, tamper-proof boxes,
        smart cards, satellites, Ku-band transmitters, multi-MIPS personal
        computers, and encryption chips now under development will be some of the
      ...
      <p>
        ...
        markets, crypto anarchy will create a liquid market for any and all
        material which can be put into words and pictures. And just as a
        seemingly minor invention like barbed wire made possible the fencing-off
        of vast ranches and farms, thus altering forever the concepts of land and
        property rights in the frontier West, so too will the seemingly minor
...
Higher Power: 2^756839 | PGP Public Key: by arrangement.`}</pre>
    </>
  );
}
