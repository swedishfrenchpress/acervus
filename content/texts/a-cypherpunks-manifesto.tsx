...
// Reproduced verbatim from activism.net/cypherpunk/manifesto.html.
  ...
  return (
    <>
      <p>
        ...
        is not secrecy. A private matter is something one doesn&rsquo;t want the
        whole world to know, but a secret matter is something one doesn&rsquo;t
      ...
      <p>
        ...
        society; we seek not to restrict any speech at all. If many parties speak
      ...
      <p>
        ...
        them in fees. When my identity is revealed by the underlying mechanism of
        the transaction, I have no privacy. I cannot here selectively reveal
        myself; I must <em>always</em> reveal myself.
      </p>
      <p>
      ...
      <p>
        ...
        cryptography is to indicate not too much desire for privacy. Furthermore,
        to reveal one&rsquo;s identity with assurance when the default is
      ...
      <p>
        ...
        of information. Information does not just want to be free, it longs to be
        free. Information expands to fill the available storage space. Information
        is Rumor&rsquo;s younger, stronger cousin; Information is fleeter of foot,
      ...
      <p>
        ...
        defend privacy, and since we can&rsquo;t get privacy unless we all do,
        we&rsquo;re going to write it. We publish our code so that our fellow
        Cypherpunks may practice and play with it. Our code is free for all to
        use, worldwide. We don&rsquo;t much care if you don&rsquo;t approve of
        the software we write. We know that software can&rsquo;t be destroyed and
        that a widely dispersed system can&rsquo;t be shut down.
      </p>
      <p>
        ...
        only so far as a nation&rsquo;s border and the arm of its violence.
      ...
      <p>
        ...
        only extends so far as the cooperation of one&rsquo;s fellows in society.
        We the Cypherpunks seek your questions and your concerns and hope we may
        engage you so that we do not deceive ourselves. We will not, however, be
        moved out of our course because some may disagree with our goals.
      </p>
      <p>
